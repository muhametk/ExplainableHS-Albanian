...
# python3.7 manual_training_inference.py best_model_json/bestModel_birnn.json True 0.01 &
#python manual_training_inference.py best_model_json/bestModel_birnnscrat.json True &
# python3.7 manual_training_inference.py best_model_json/bestModel_birnnscrat.json True 0.01 &
...
# sleep 15s
# python3.7 manual_training_inference.py best_model_json/bestModel_birnnatt.json True 0.01 &
# sleep 15s
