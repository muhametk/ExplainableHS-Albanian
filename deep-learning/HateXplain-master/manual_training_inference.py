...
#         model.eval()
    ...
    if(params['num_classes']==3):
        ...
        testrocauc=0
        try:
            logits_all_final_12 = [logits.flatten() for logits in logits_all]
            true_labels_final = true_labels.flatten()
            testrocauc=roc_auc_score(true_labels_final, logits_all_final_12, multi_class='ovo',average='macro')
        except:
            testrocauc=0
